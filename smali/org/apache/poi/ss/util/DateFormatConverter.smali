...
.method public static convert(Ljava/util/Locale;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, p1}, Lorg/apache/poi/ss/util/DateFormatConverter$DateFormatTokenizer;-><init>(Ljava/lang/String;)V
    ...
    .line 365
    :cond_1
    sget-object v2, Lorg/apache/poi/ss/util/DateFormatConverter;->tokenConversions:Ljava/util/Map;
    ...
    .line 366
    .local v2, "mappedToken":Ljava/lang/String;
    if-nez v2, :cond_2
    ...
    .line 367
    .end local v2    # "mappedToken":Ljava/lang/String;
    goto :goto_0
...
.method public static convert(Ljava/util/Locale;Ljava/text/DateFormat;)Ljava/lang/String;
    ...
    .line 349
    .local v0, "ptrn":Ljava/lang/String;
    invoke-static {p0, v0}, Lorg/apache/poi/ss/util/DateFormatConverter;->convert(Ljava/util/Locale;Ljava/lang/String;)Ljava/lang/String;
...
.method public static getJavaDateTimePattern(ILjava/util/Locale;)Ljava/lang/String;
    ...
    .line 424
    :cond_2
    const-string v1, "MMMM d, yyyy h:mm:ss a"

    return-object v1

    .line 426
    :cond_3
    const-string v1, "dddd, MMMM d, yyyy h:mm:ss a"
...
.method public static getPrefixForLocale(Ljava/util/Locale;)Ljava/lang/String;
    ...
    .line 339
    .local v2, "parentLocale":Ljava/util/Locale;
    sget-object v5, Lorg/apache/poi/ss/util/DateFormatConverter;->logger:Lorg/apache/poi/util/POILogger;
    ...
    const-string v9, "Unable to find prefix for "
    ...
    invoke-virtual {p0, v10}, Ljava/util/Locale;->getDisplayName(Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v8}, Ljava/util/Locale;->getDisplayName(Ljava/util/Locale;)Ljava/lang/String;
    ...
    .line 344
    .end local v2    # "parentLocale":Ljava/util/Locale;
    :cond_0
    return-object v1
.end method

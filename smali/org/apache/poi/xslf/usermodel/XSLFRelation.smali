...
.method static constructor <clinit>()V
    ...
    const-class v1, Lorg/apache/poi/xslf/usermodel/XSLFNotes;

    const-string v3, "application/vnd.openxmlformats-officedocument.presentationml.notesSlide+xml"

    const-string v4, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/notesSlide"

    const-string v5, "/ppt/notesSlides/notesSlide#.xml"

    invoke-direct {v0, v3, v4, v5, v1}, Lorg/apache/poi/xslf/usermodel/XSLFRelation;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    const-class v1, Lorg/apache/poi/xslf/usermodel/XSLFSlide;

    const-string v3, "application/vnd.openxmlformats-officedocument.presentationml.slide+xml"

    const-string v4, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/slide"

    const-string v5, "/ppt/slides/slide#.xml"
    ...
    const-class v1, Lorg/apache/poi/xslf/usermodel/XSLFSlideLayout;

    const-string v3, "application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"

    const-string v4, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"

    const-string v5, "/ppt/slideLayouts/slideLayout#.xml"
    ...
    const-class v1, Lorg/apache/poi/xslf/usermodel/XSLFSlideMaster;

    const-string v3, "application/vnd.openxmlformats-officedocument.presentationml.slideMaster+xml"

    const-string v4, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideMaster"

    const-string v5, "/ppt/slideMasters/slideMaster#.xml"
    ...
    const-class v1, Lorg/apache/poi/xslf/usermodel/XSLFNotesMaster;

    const-string v3, "application/vnd.openxmlformats-officedocument.presentationml.notesMaster+xml"

    const-string v4, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/notesMaster"

    const-string v5, "/ppt/notesMasters/notesMaster#.xml"
    ...
    const-class v1, Lorg/apache/poi/xslf/usermodel/XSLFComments;

    const-string v3, "application/vnd.openxmlformats-officedocument.presentationml.comments+xml"

    const-string v4, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/comments"

    const-string v5, "/ppt/comments/comment#.xml"
    ...
    const-class v1, Lorg/apache/poi/xslf/usermodel/XSLFCommentAuthors;

    const-string v3, "application/vnd.openxmlformats-officedocument.presentationml.commentAuthors+xml"

    const-string v4, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/commentAuthors"

    const-string v5, "/ppt/commentAuthors.xml"
    ...
    const-class v1, Lorg/apache/poi/xslf/usermodel/XSLFTheme;
    ...
    const-string v5, "/ppt/theme/theme#.xml"
    ...
    const-string v4, "/ppt/drawings/vmlDrawing#.vml"

    invoke-direct {v0, v1, v3, v4, v2}, Lorg/apache/poi/xslf/usermodel/XSLFRelation;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    const-class v1, Lorg/apache/poi/xslf/usermodel/XSLFChart;
    ...
    const-string v5, "/ppt/charts/chart#.xml"
    ...
    const-class v3, Lorg/apache/poi/xslf/usermodel/XSLFPictureData;
    ...
    invoke-direct {v0, v1, v4, v5, v3}, Lorg/apache/poi/xslf/usermodel/XSLFRelation;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    const-class v1, Lorg/apache/poi/xslf/usermodel/XSLFPictureData;

    invoke-direct {v0, v2, v4, v2, v1}, Lorg/apache/poi/xslf/usermodel/XSLFRelation;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)V
...
.method public static getInstance(Ljava/lang/String;)Lorg/apache/poi/xslf/usermodel/XSLFRelation;
    ...
    check-cast v0, Lorg/apache/poi/xslf/usermodel/XSLFRelation;

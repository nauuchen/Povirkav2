...
.method static constructor <clinit>()V
    ...
    const-class v1, Lorg/apache/poi/xssf/usermodel/XSSFSheet;

    const-string v2, "application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml"

    const-string v3, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet"

    const-string v5, "/xl/worksheets/sheet#.xml"

    invoke-direct {v0, v2, v3, v5, v1}, Lorg/apache/poi/xssf/usermodel/XSSFRelation;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    const-class v1, Lorg/apache/poi/xssf/usermodel/XSSFChartSheet;

    const-string v2, "application/vnd.openxmlformats-officedocument.spreadsheetml.chartsheet+xml"

    const-string v3, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chartsheet"

    const-string v5, "/xl/chartsheets/sheet#.xml"
    ...
    const-class v1, Lorg/apache/poi/xssf/model/SharedStringsTable;

    const-string v2, "application/vnd.openxmlformats-officedocument.spreadsheetml.sharedStrings+xml"

    const-string v3, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/sharedStrings"

    const-string v5, "/xl/sharedStrings.xml"
    ...
    const-class v1, Lorg/apache/poi/xssf/model/StylesTable;

    const-string v2, "application/vnd.openxmlformats-officedocument.spreadsheetml.styles+xml"

    const-string v3, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles"

    const-string v5, "/xl/styles.xml"
    ...
    const-class v1, Lorg/apache/poi/xssf/usermodel/XSSFDrawing;

    const-string v2, "application/vnd.openxmlformats-officedocument.drawing+xml"

    const-string v3, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/drawing"

    const-string v5, "/xl/drawings/drawing#.xml"
    ...
    const-class v1, Lorg/apache/poi/xssf/usermodel/XSSFVMLDrawing;

    const-string v2, "application/vnd.openxmlformats-officedocument.vmlDrawing"

    const-string v3, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/vmlDrawing"

    const-string v5, "/xl/drawings/vmlDrawing#.vml"
    ...
    const-class v1, Lorg/apache/poi/xssf/usermodel/XSSFChart;
    ...
    const-string v5, "/xl/charts/chart#.xml"
    ...
    const-class v1, Lorg/apache/poi/xssf/model/MapInfo;

    const-string v2, "application/xml"

    const-string v3, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/xmlMaps"

    const-string v5, "/xl/xmlMaps.xml"
    ...
    const-class v1, Lorg/apache/poi/xssf/model/SingleXmlCells;

    const-string v2, "application/vnd.openxmlformats-officedocument.spreadsheetml.tableSingleCells+xml"

    const-string v3, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/tableSingleCells"

    const-string v5, "/xl/tables/tableSingleCells#.xml"
    ...
    const-class v1, Lorg/apache/poi/xssf/usermodel/XSSFTable;

    const-string v2, "application/vnd.openxmlformats-officedocument.spreadsheetml.table+xml"

    const-string v3, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/table"

    const-string v5, "/xl/tables/table#.xml"
    ...
    const-class v1, Lorg/apache/poi/xssf/usermodel/XSSFPictureData;

    const-string v2, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/image"

    invoke-direct {v0, v4, v2, v4, v1}, Lorg/apache/poi/xssf/usermodel/XSSFRelation;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    invoke-direct {v0, v3, v2, v5, v1}, Lorg/apache/poi/xssf/usermodel/XSSFRelation;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    const-string v5, "/xl/comments#.xml"
    ...
    const-string v5, "/xl/externalLinks/externalLink#.xmll"
    ...
    const-string v5, "/xl/pivotTables/pivotTable#.xml"
    ...
    const-string v5, "/xl/pivotCache/pivotCacheDefinition#.xml"
    ...
    const-string v5, "/xl/pivotCache/pivotCacheRecords#.xml"
...
.method public static getInstance(Ljava/lang/String;)Lorg/apache/poi/xssf/usermodel/XSSFRelation;
    ...
    check-cast v0, Lorg/apache/poi/xssf/usermodel/XSSFRelation;

...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v1, v2, v0}, Lorg/apache/poi/hssf/util/HSSFColor;-><init>(IILjava/awt/Color;)V
...
.method static synthetic access$000(Lorg/apache/poi/hssf/util/HSSFColor;)Ljava/awt/Color;
    .locals 1
    .param p0, "x0"    # Lorg/apache/poi/hssf/util/HSSFColor;
...
.method private static createColorsByHexStringMap()Ljava/util/Map;
    ...
    .line 221
    .local v0, "eList":Ljava/util/Map;, "Ljava/util/Map<Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;Lorg/apache/poi/hssf/util/HSSFColor;>;"
    ...
    .line 223
    .local v1, "result":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lorg/apache/poi/hssf/util/HSSFColor;>;"
    ...
    .line 224
    .local v3, "colorRef":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;Lorg/apache/poi/hssf/util/HSSFColor;>;"
    invoke-interface {v3}, Ljava/util/Map$Entry;->getKey()Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;

    invoke-virtual {v4}, Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;->getHexString()Ljava/lang/String;
    ...
    .line 228
    .end local v3    # "colorRef":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;Lorg/apache/poi/hssf/util/HSSFColor;>;"
...
.method private static createColorsByIndexMap()Ljava/util/Map;
    ...
    .line 192
    .local v1, "result":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;Lorg/apache/poi/hssf/util/HSSFColor;>;"
    invoke-interface {v0}, Ljava/util/Map;->entrySet()Ljava/util/Set;
    ...
    invoke-virtual {v4}, Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;->getIndex()S
    ...
    check-cast v5, Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;

    invoke-virtual {v5}, Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;->getIndex2()S
    ...
    .line 198
    .local v5, "index2":Ljava/lang/Integer;
    ...
    .end local v5    # "index2":Ljava/lang/Integer;
    :cond_1
    goto :goto_0
...
.method public static toHSSFColor(Lorg/apache/poi/ss/usermodel/Color;)Lorg/apache/poi/hssf/util/HSSFColor;
    ...
    const-string v1, "Only HSSFColor objects are supported"

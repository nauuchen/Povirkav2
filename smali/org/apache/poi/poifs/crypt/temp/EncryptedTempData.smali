...
.method public constructor <init>()V
    ...
    sget-object v3, Lorg/apache/poi/poifs/crypt/temp/EncryptedTempData;->cipherAlgorithm:Lorg/apache/poi/poifs/crypt/CipherAlgorithm;

    iget-object v3, v3, Lorg/apache/poi/poifs/crypt/CipherAlgorithm;->jceId:Ljava/lang/String;

    invoke-direct {v2, v1, v3}, Ljavax/crypto/spec/SecretKeySpec;-><init>([BLjava/lang/String;)V

    iput-object v2, p0, Lorg/apache/poi/poifs/crypt/temp/EncryptedTempData;->skeySpec:Ljavax/crypto/spec/SecretKeySpec;

    .line 62
    const-string v2, "poi-temp-data"

    const-string v3, ".tmp"

    invoke-static {v2, v3}, Lorg/apache/poi/util/TempFile;->createTempFile(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    iput-object v2, p0, Lorg/apache/poi/poifs/crypt/temp/EncryptedTempData;->tempFile:Ljava/io/File;
...
.method public dispose()V
    ...
    iget-object v5, p0, Lorg/apache/poi/poifs/crypt/temp/EncryptedTempData;->tempFile:Ljava/io/File;
    ...
    const-string v5, " can\'t be removed (or was already removed."
